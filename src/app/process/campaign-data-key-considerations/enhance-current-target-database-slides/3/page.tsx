...
export default function TargetDatabaseSlide3() {
        ...
        <div className="flex items-start">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900 mb-4">
              Would you like to purchase company-level / technical intelligence appends, as well as new contacts?
            </h1>
            <ul className="text-lg list-disc list-inside text-gray-700 mb-6 leading-relaxed">
              <li>For example, volume of PC users</li>
              <li>Installed server vendor</li>
              <li>Installed security vendor</li>
              <li>Installed PBX vendor</li>
              <li>and more...</li>
            </ul>
          </div>
        </div>
