...
export default function TargetDatabaseSlide2() {
    ...
    >
      ...
      >
        <div className="flex items-start">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900 mb-4">
              Does your current data include large volumes of company/contact duplications, and how fresh is your data?
            </h1>
          </div>
        </div>
        ...
        <div className="flex justify-end mt-6">
          <Image
            src="/images/Data With Question Marks.png"
            alt="Data with Question Marks"
            width={250}
            height={200}
