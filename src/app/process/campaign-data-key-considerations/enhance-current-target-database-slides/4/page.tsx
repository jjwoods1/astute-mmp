...
export default function TargetDatabaseSlide4() {
        ...
        <div className="flex items-start">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900 mb-4">
              Would you like to purchase companies within your identified target market, but <strong>NOT</strong> in your current prospect database?
            </h1>
          </div>
        </div>
