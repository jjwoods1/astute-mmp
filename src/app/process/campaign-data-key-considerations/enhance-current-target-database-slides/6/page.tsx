...
export default function TargetDatabaseSlide6() {
        ...
        <div className="flex items-start">
          ...
          <div>
            ...
            <ul className="text-lg list-disc list-inside text-gray-700 mb-6">
              ...
              <li>
                Multiple contacts provide more avenues into larger organisations, increasing your
                chance of booking a meeting with your target companies
              </li>
            </ul>
          </div>
        </div>
